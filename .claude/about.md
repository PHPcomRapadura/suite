...
- **Origem do avatar/logo**: mesma resolução R2-primeiro-depois-HTTP do `SocialAssetCanvas::fetchImage()` usada para capa/logo do evento — reaproveitada, não duplicada, tanto pelo palestrante quanto pelo patrocinador.
