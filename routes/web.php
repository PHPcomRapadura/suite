...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/login', [AdminLoginController::class, 'login'])->middleware('throttle:auth');
...
Route::prefix('cfp')->name('cfp.')->group(function () {
    ...
    Route::post('/login', [CfpAuthController::class, 'login'])->name('login')->middleware('throttle:auth');
    Route::post('/register', [CfpAuthController::class, 'register'])->name('register')->middleware('throttle:auth');
    Route::post('/logout', [CfpAuthController::class, 'logout'])->name('logout');
    Route::post('/forgot-password', [CfpPasswordResetController::class, 'sendLink'])->name('password.email')->middleware('throttle:auth');
    Route::post('/reset-password', [CfpPasswordResetController::class, 'reset'])->name('password.reset')->middleware('throttle:auth');
